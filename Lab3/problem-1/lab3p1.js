        ...
        let liEl=`<li class="note">
                        ...
                        <div class="bottom-content">
                            ...
                            <div class="settings">
                                ...
                                <i onClick="deleteNode(${index})" class="uil uil-trash"></i>
                            </div>
                        </div>
                    </li>`;
...
const addBox$ = rxjs.fromEvent(addBox,'click')
...
const closeIcon$ = rxjs.fromEvent(closeIcon, 'click')
...
const addBtn$ = rxjs.fromEvent(addBtn, 'click')
